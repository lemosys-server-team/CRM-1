...
<head>
  ...
  <link rel="stylesheet"  href="{{ asset('admin-theme/css/custom-style.css') }}">
  @yield('styles')
</head>
<body id="page-top">
    <!-- Page Wrapper -->
...
jQuery(document).ready(function(){
    ...
    if(jQuery('ul#accordionSidebar a.active').length==0){
      ...
      var element = jQuery('ul#accordionSidebar a.active').closest('li')
    }
